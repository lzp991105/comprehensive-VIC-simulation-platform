...
speeds = {'car': 0.11, 'truck': 0.09}  # average speeds of vehicles

# Coordinates of vehicles' start车辆启动坐标
x = {'right': [0, 0, 0, 0], 'left': [1346, 1346, 1346, 1346]}
y = {'right': [470, 563, 659, 744], 'left': [20, 110, 205, 295]}
...
vehiclesTurned = {'right': {0: [], 1: [], 2: [], 3: []}, 'left': {0: [], 1: [], 2: [], 3: []}}
vehiclesNotTurned = {'right': {0: [], 1: [], 2: [], 3: []}, 'left': {0: [], 1: [], 2: [], 3: []}}
...
class Main(end_time):
    ...
    background = pygame.image.load('images/Expressway.png')
    ...
    while run_time <= end_time:
        ...
        for vehicle in simulation:
            ...
            vehicle.move()
            if (0 <= vehicle.x <= screenWidth and 0 <= vehicle.y <= screenHeight) and time.time() - vehicle.time_car >= interval:
                # 保留一位小数并进行四舍五入
